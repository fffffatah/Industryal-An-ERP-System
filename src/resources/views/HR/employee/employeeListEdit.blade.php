                    ...
                    <div class="border border-primary w-75  m-auto">
                        ...
                        @csrf
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="employeeid" name="employee_id" Value="{{$employee['employee_id']}}" >
                                <span class="text-danger">{{$errors->first('employee_id')}}</span>
                            </div>
                        
                            <div class="form-group">
                                <label>Employee Name</label> 
                                <input type="txt" class="form-control" id="employeename" name="employee_name" Value="{{$employee['employee_name']}}" >
                                <span class="text-danger">{{$errors->first('employee_name')}}</span>
                            </div>
                            
                            <div class="from-group">
                                <label>Gender</label>
                                <input type="radio" name="gender" value="{{$employee['gender']}}"
                            ...
                            <div class="foem-group">
                                ...
                                <input type="text" class="form-control" id="presentaddress" name="present_address" Value="{{$employee['present_address']}}" >
                                <span class="text-danger">{{$errors->first('present_address')}}</span>
                            </div>
                            <div class="from-group">
                                 <label>Phone</label></td>
                                <input type="number" class="form-control" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" Value="{{$employee['phone']}}" >
                                <span class="text-danger">{{$errors->first('phone')}}</span>
                            </div>
                            
                            <div class="from-group">
                                <label>Job Position</label> 
                                <input type="txt" class="form-control" id="position" name="job_position" Value="{{$employee['job_position']}}"  >
                                <span class="text-danger">{{$errors->first('job_position')}}</span>
                            </div>
                            <div class="from-group">
                                <label>Start Time(per day)</label> 
                                <input type="time" class="form-control" id="stime" name="start_time" Value="{{$employee['start_time']}}"  >
                                <span class="text-danger">{{$errors->first('start_time')}}</span>
                            </div>
                            <div class="from-group">
                                <label>End Time(per day)</label> 
                                <input type="time" class="form-control" id="etime" name="end_time" Value="{{$employee['end_time']}}" >
                                <span class="text-danger">{{$errors->first('end_time')}}</span>
                            </div>

                            <div class="form-group">
                                <label>Hour Worked(Per week)</label> 
                                <input type="txt" class="form-control" id="worked" name="hour_worked" Value="{{$employee['hour_worked']}}" >
